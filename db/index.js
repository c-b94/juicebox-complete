...
async function getPostById(postId) {
  ...
  try {
    ...
    console.error('getpostbyid failed !')
    throw error;
  }
}

async function createTags(tagList) {
    console.log("Starting to create tags index...");
     if (tagList.length === 0) {
    return [ ];
  }
  ...
  try {
    ...
    console.error('createTags index Failed!');
    throw(error);
  }
}

async function createPostTag(postId,tagId){
  console.log("createPostTag is starting ...")
  try {
    await client.query(`
    ...
    console.log("createPostTag failed!")
    throw error;
  }
}
